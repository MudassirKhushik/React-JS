...
function App() {
  const [color, setColor] = useState("#557788")
    ...
    <div className = "w-full h-screen duration-200 " style = {{backgroundColor : color}}>
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-3 rounded-2xl ">
          ...
          className="outline-none px-4 py-4 rounded-full text-white shadow-lg" style={{backgroundColor : "Black"}}>
            Black
          </button>

          <button onClick={() => setColor("purple")}
          className="outline-none px-4 py-4 rounded-full text-white shadow-lg" style={{backgroundColor : "Purple"}}>
            Purple
          </button>
        </div>
      </div>
